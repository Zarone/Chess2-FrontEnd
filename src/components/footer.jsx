...
export default function Footer(){
    return <div className="d-footer">
            <p className="d-footer-text">
                ...
                <a className="d-link" href="https://www.youtube.com/c/OatsJenkins">YouTube</a><br></br>
                <a className="d-link" href="https://www.instagram.com/oatsjenkins/?utm_source=qr">Instagram</a><br></br>
                <a className="d-link" href='https://twitter.com/OatsJenkins?t=RYdPzIAjQaWbyAL6ccX6Zg'>Twitter</a><br></br>
                <a className="d-link" href="https://www.tiktok.com/@oatsjenkins">TikTok</a><br></br><br></br>
                ...
                <div className="d-discord-btn-container">
                    <a className="d-discord-anchor" href="https://discord.com/invite/aGFThSgGsj"></a>
